...
public class PhysicalActivityProgramme {
	...
	public ActiveLifestyleActivity getActiveLifestyleActivity() {
		return activeLifestyleActivity;
	}

	public void setActiveLifestyleActivity(ActiveLifestyleActivity activeLifestyleActivity) {
		this.activeLifestyleActivity = activeLifestyleActivity;
	}

	private ActiveLifestyleActivity activeLifestyleActivity;
